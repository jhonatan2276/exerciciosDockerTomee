...
docker run -d --name host1 -h host1 --link mysql01:mysql8 -p 8081:8080 tomee-war
docker run -d --name host2 -h host2 --link mysql01:mysql8 -p 8082:8080 tomee-war
docker run -d --name host3 -h host3 --link mysql01:mysql8 -p 8083:8080 tomee-war
