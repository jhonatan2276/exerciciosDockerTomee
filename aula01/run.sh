...
# docker run -d --name mysql01 -h mysql01 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=teste MYSQL_DATABASE=base mysql8
docker run -d --name host1 -h host1 --link mysql01:mysql01 -p 8081:8080 tomee-war
docker run -d --name host2 -h host2 --link mysql01:mysql01 -p 8082:8080 tomee-war
docker run -d --name host3 -h host3 --link mysql01:mysql01 -p 8083:8080 tomee-war
